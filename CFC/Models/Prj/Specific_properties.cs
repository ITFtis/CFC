...
namespace CFC.Models.Prj
{
    ...
    /// 燃料計算
    /// </summary>
    public class Specific_properties
    {
        public static readonly String TYPE_ALUMIN = "Alumin";
        public static readonly String TYPE_NO = "NO";
        public static readonly String TYPE_CONCRETE = "Concrete";
        public static readonly String TYPE_NH = "NH";
        ...
        [ColumnDef(VisibleView = false,VisibleEdit =true, EditType = EditType.Select,
            ...
            SelectSourceModelNamespace = "CFC.Models.Prj.Specific_type, CFC",
        ...
        [NotMapped]
        [ColumnDef(Visible = true, Filter = false, VisibleEdit = false)]
        public string TypeName { get {
                var selectedType = Controllers.Api.DateViewController.AllSpecificType.Where(e => e.Id == this.Type).FirstOrDefault();
