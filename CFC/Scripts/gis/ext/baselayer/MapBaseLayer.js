    ...
    pluginclass.prototype = {
        ...
        initUI: function () {
            ...
            $.each(this.settings.tiles, function (k, val) {
                ...
                var _html;
                if (val.groupTiles) {
                    _html = '<div class="btn-group"><button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">'+val.name+'<span class="caret"></span></button>'+
                        '<ul class="dropdown-menu" role="menu">'
                    $.each(val.groupTiles, function () {
                        _html += '<li><a href="#" data-gtype="' + this.name + '">' + this.name + '</a></li>';
                    });
                    _html += '</ul></div>';
