...
(function ($) {
    ...
    var pluginclass = function (element, e) {
        ...
        this.settings = { map: undefined, server: "https://140.124.60.39/Map/WS/KmlUpload.ashx", maxSize: 2, useKmlCtrl:false };//maxSize:M
    ...
    pluginclass.prototype = {
        ...
        initUI: function () {
            ...
            $('<div class="form-group"><span class="col-sm-6 col-sm-offset-1 btn btn-success">匯 入</span><span class="col-sm-3 col-sm-offset-2 btn btn-danger">清除圖層</span></div>').appendTo($_form);
