    ...
    $.CctvCtrl = {
        ...
        defaultSettings: {
            ...
            pinInfoContent: function (data, infofields) {
                ...
                var $div = $('<div id="carousel_' + iid + '" class="carousel slide cctv-info-content ' + ('cctv-' + currentsetting.name + '-info-content') + '" data-ride="carousel" data-interval="99999999" style="width:100%;">');// style="width:' + this.cctvSize.width + 'px;height:' + this.cctvSize.height + 'px">');
                var $ol = $('<ol class="carousel-indicators">');
                var $sdiv = $('<div class="carousel-inner">');
                
                var cc =0;
                $.each(data.urls, function (idx,item) {
                    $ol.append(' <li data-target="#carousel_' + iid + '" data-slide-to="'+cc+'"' + (cc == 0 ? ' class="active"' : "") + '></li>');

                    $sdiv.append('<div class="item ' + (cc == 0 ? 'active' : '') + '"><img alt="' + this.name + '" class="img-cctv" data-index="' + idx + '" data-imgsrc="' + this.url + '"  style="margin: auto; width:' + currentsetting.cctvSize.width + 'px;height:' + currentsetting.cctvSize.height + 'px"></img>' +// min-width:' + currentsetting.cctvSize.width + 'px;min-height:' + currentsetting .cctvSize.height+ 'px"></img>' +
                ...
                if (data.urls.length > 1) {
                    $div.append('<a class="left carousel-control" href="#carousel_' + iid + '" role="button" data-slide="prev">' +
                            '<span class="glyphicon glyphicon-chevron-left"></span>' +
                        '</a>' +
                        '<a class="right carousel-control" href="#carousel_' + iid + '" role="button" data-slide="next">' +
