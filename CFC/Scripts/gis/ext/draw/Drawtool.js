...
(function ($) {
    ...
    pluginclass.prototype.initUI = function () {
        ...
        uicontentstr += '<div id="draw-color-style-div" style="margin-top:8px;margin-bottom:8px;display:none">樣式<hr><div style="margin-bottom:2px;"><lable>邊線: </lable><input type="text" id="strokepicker" class="cpicker"></input></div>' +
        ...
        uicontentstr += '<div style="margin-top:8px;margin-bottom:8px;">操作<hr><label class="btn  undoctrl"  title="還原"></label><label class="btn btn-primary clearctrl" title="清除"></label><label class="btn btn-primary stopctrl" title="結束" ></label></div>' +
        '<by><div class="calresult" style="min-height:40px;"></div><br><div class="ctrlinfo">選擇樣式選項後開始劃圖' + (!current.settings.singleGraphic ? '<br>再次點選同一樣式後結束劃圖</div>' : '');
        ...
        if (this.settings.colorSelector) {
            ...
            $(".colpick").mouseleave(function () {
                $('.cpicker', this.$element).colpickHide();
            });
